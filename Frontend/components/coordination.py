...
def _node_card_html(node_id: str, name: str, tier: str, status: str,
    ...
    return f"""
<div class="node-card" style="background:#FFFFFF;border-radius:12px;padding:12px 14px;
            cursor:pointer;margin-bottom:8px;transition:box-shadow 180ms ease,transform 180ms ease;{sel}">
